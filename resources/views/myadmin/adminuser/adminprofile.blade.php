...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="row">
        <div class="col-md-12">
           <h4><span style="color: #006368;font-weight: bold;">Admin Name: </span> {{Auth::user()->name}}</h4>
           <h4><span style="color: #006368;font-weight: bold;"> Admin Email: </span>{{Auth::user()->email}}</h4>
        </div>
     </div><br><br>
      <div class="row">
        <div class="col-md-12">
