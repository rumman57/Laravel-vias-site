 <footer class="main-footer">
     ...
     <strong>Copyright &copy; By Rumman <a href="http://www.rh-rumman.me" target="_blank">www.rh-rumman.me</a>.</strong> All rights Reserved
    reserved.
  </footer>
...
<script src="{{ URL::asset('https://code.jquery.com/ui/1.11.4/jquery-ui.min.js') }}"></script></script>
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<script type="text/javascript" src="{{ URL::asset('bootstrap/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js') }}"></script>
...
<script type="text/javascript" src="{{ URL::asset('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js') }}"></script>
...
<script type="text/javascript" src="{{ URL::asset('dist/js/dashboard.js') }}"></script>
