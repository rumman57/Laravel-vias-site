...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Show Block Visa Country
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Show Block Visa Country</a></li>
        <li class="active"> Block Visa Country</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                 <tr>
                  ...
                  <th style="text-align: center;" width="20%">Remove From Block</th>
