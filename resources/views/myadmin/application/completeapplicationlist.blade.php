  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Complete Application</a></li>
        <li class="active">Complete Application List</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              ...
              <?php $i++;?>
                <tr>
                  ...
                  <td>
                     <a href="{{route('make.application.incomplete',$apply->ref_number)}}"><button class="btn btn-warning">Make Inomplete</button></a>
                  </td>
